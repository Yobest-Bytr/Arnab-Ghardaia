...
import { Sparkles, Loader2, Users, Brain } from 'lucide-react';
...
const Signup = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      showSuccess('Welcome to the elite 1%.');
    ...
    <div className="min-h-screen bg-[#020408] text-white flex items-center justify-center px-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl font-black tracking-tighter mb-2">Create Account</h1>
          <p className="text-white/40 font-medium">Start your cognitive journey</p>
        </div>
