...
const Hero3D = () => {
  return (
    <div className="w-full h-[600px] relative pointer-events-none select-none">
      <Canvas 
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-gray-950 via-transparent to-gray-950 opacity-50" />
    </div>
  );
};
