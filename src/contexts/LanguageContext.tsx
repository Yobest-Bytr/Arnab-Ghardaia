...
const translations: Translations = {
  ...
  // About Page
  aboutHero: { en: "Our Story at Aranib Farm", ar: "قصتنا في مزرعة الأرانب", fr: "Notre histoire à la Ferme Aranib" },
  aboutDesc: { en: "Founded in 2015, we've grown from a small family hobby into one of the region's most respected rabbit breeding facilities.", ar: "تأسست في عام 2015، ونمت من هواية عائلية صغيرة إلى واحدة من أكثر مرافق تربية الأرانب احتراماً في المنطقة.", fr: "Fondée en 2015, nous sommes passés d'un petit passe-temps familial à l'un des centres d'élevage de lapins les plus respectés de la région." },
  ...
  contactDesc: { en: "Have questions about our breeds or want to visit the farm? We're here to help.", ar: "لديك أسئلة حول سلالاتنا أو تريد زيارة المزرعة؟ نحن هنا للمساعدة.", fr: "Vous avez des questions sur nos races ou vous souhaitez visiter la ferme ? Nous sommes là pour vous aider." },
